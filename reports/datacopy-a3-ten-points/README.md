...
**下面这组旧10点尚未测到吞吐平台。** 到32KiB时带宽仍明显增长，116.12/111.28GB/s只能称为此扫描已测的最高值。后续已完成扩大容量、批量和双窗口的[A3实测闭环](../datacopy-a3-capacity/README.md)：小工作集约230/200GB/s，64MiB环约36～37GB/s。复现见[扩展扫描步骤](throughput-scan.md)。
